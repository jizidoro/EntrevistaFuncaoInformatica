using System;
using System.Text;
using EntrevistaFuncaoInformatica.CrossCutting.Authorization;
...
namespace EntrevistaFuncaoInformatica.WebApi.Configurations
{
    public static class IdentitySetup
    {
        ...
        public static void AddAuthSetup(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddAuthorization(options =>
            {
                options.AddPolicy("CanWriteClienteSistemaData", policy => policy.Requirements.Add(new ClaimRequirement("ClienteSistemas", "Write")));
                options.AddPolicy("CanRemoveClienteSistemaData", policy => policy.Requirements.Add(new ClaimRequirement("ClienteSistemas", "Remove")));
            });
        }
    }
}